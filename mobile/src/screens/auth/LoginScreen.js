  ...
  return (
    <AuthShell>
      <Segmented
        ...
        value="login"
        onChange={(v) => v === "signup" && navigation.replace("Signup")}
      />
      ...
      <PillButton title="Login" loading={loading} onPress={onSubmit} />
...
const styles = StyleSheet.create({
  ...
  forgot: { color: "white", textAlign: "right", marginTop: 10, fontWeight: "700" },
});
